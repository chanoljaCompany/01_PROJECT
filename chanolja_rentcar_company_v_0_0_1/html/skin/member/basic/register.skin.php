...
<!-- 회원가입약관 동의 시작 { -->
<div style="max-width: 1200px" class="register">

    <form style="padding-top: 120px";  name="fregister" id="fregister" action="<?php echo $register_action_url ?>" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
