...
include "$_SERVER[DOCUMENT_ROOT]/real_reservation/top.php";
  $division = "management";
	$sql = "SELECT *	FROM $MANAGEMENT_TB WHERE user_id = '".$_SESSION['session_user_id']."' ORDER BY seq LIMIT 0,1";
	$row = sql_fetch($sql);
...
<div id="admin_content" >
    ...
    <? include "$_SERVER[DOCUMENT_ROOT]/real_reservation/admin_header.php";?>
		<section id="wrapper">
    		...
    		<iframe id="board" width="100%" height="1400px" scrolling="no" src="https://fms.imsconnect.co.kr/history" frameborder="0"></iframe>
