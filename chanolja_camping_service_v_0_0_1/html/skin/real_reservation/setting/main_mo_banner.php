...
$bannerImg_1 = $rows['banner_images_1'] ? "/upload/banner/mo/".$rows['banner_images_1'] : '';
$bannerImg_2 = $rows['banner_images_2'] ? "/upload/banner/mo/".$rows['banner_images_2'] : '';
$bannerImg_3 = $rows['banner_images_3'] ? "/upload/banner/mo/".$rows['banner_images_3'] : '';
$bannerImg_4 = $rows['banner_images_4'] ? "/upload/banner/mo/".$rows['banner_images_4'] : '';
$bannerImg_5 = $rows['banner_images_5'] ? "/upload/banner/mo/".$rows['banner_images_5'] : '';
$bannerImg_6 = $rows['banner_images_6'] ? "/upload/banner/mo/".$rows['banner_images_6'] : '';
$bannerImg_7 = $rows['banner_images_7'] ? "/upload/banner/mo/".$rows['banner_images_7'] : '';
$bannerImg_8 = $rows['banner_images_8'] ? "/upload/banner/mo/".$rows['banner_images_8'] : '';
// print_r($rows);
?>
<style>
...
<form name = "imguploadForm" id = "imguploadForm" method="post" enctype="multipart/form-data">
 ...
 <input type="hidden"	name="userid" id="userid" value="<?=$userid?>">
    ...
    <tr>
      <th scope="row">배너 이미지<br><font color="red"><b>최적 사이즈 : 1080 x 670</b></font></th>
      <td colspan="3">
...
<script>
    ...
    $(function(){
        ...
        $('.dropify').dropify({
            messages: {
                'default': '최적이미지는 1080 x 670 사이즈입니다.',
                'replace': '최적이미지는 1080 x 670 사이즈입니다',
                'remove':  '삭제',
                'error':   '오류가 발생하였습니다.'
            }
        });
