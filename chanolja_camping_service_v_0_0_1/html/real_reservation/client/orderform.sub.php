        ...
        <section id="sod_frm_orderer">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_name" value="김유혁" id="od_name" required class="frm_input required" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="password" name="od_pwd" id="od_pwd" required class="frm_input required" maxlength="20" value="rladbgur">
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_tel" value="01047126104" id="od_tel" required class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_hp">핸드폰</label></th>
                    <td><input type="text" name="od_hp" value="01047126104" id="od_hp" class="frm_input" maxlength="20"></td>
                </tr>
                <tr>
                    <th scope="row">주소</th>
                    <td>
                        <label for="od_zip" class="sound_only">우편번호<strong class="sound_only"> 필수</strong></label>
                        <input type="text" name="od_zip" value="01000" id="od_zip" required class="frm_input required" size="8" maxlength="6" placeholder="우편번호">
                        ...
                        <input type="text" name="od_addr1" value="서울 강북구 방학로 382" id="od_addr1" required class="frm_input frm_address required" size="60" placeholder="기본주소">
                        <label for="od_addr1" class="sound_only">기본주소<strong class="sound_only"> 필수</strong></label><br>
                        <input type="text" name="od_addr2" value="12" id="od_addr2" class="frm_input frm_address" size="60" placeholder="상세주소">
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_email" value="somang73@naver.com" id="od_email" required class="frm_input required" size="35" maxlength="100"></td>
                </tr>
