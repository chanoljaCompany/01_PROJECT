						...
						<div class="astute-single-blog-content">
							<div class="single-blog-content">
								<!-- 게시판 목록 시작 { -->
                                    ...
                                    <div class="row">
                            			<div class="col-md-6">
                            			<!--<span>Total <?//php echo number_format($total_count) ?> notice</span>-->
                            			<!--<span>전체 <?//php echo number_format($total_count) ?> 공지사항</span>-->
                                		<!-- <?php echo $page ?> page -->
                                        </div>
                            			<div class="col-md-6">
                            				<div class="portfolio_menu text-right" style="margin-bottom:0px;">
                            					<ul class="filter_menu ">
                            						<?php if ($rss_href || $write_href) { ?>
                                                        <?php if ($rss_href) { ?><li onclick="document.location.href='<?php echo $rss_href ?>'">RSS</li><?php } ?>
                                                        <?php if ($admin_href) { ?><li onclick="document.location.href='<?php echo $admin_href ?>'">관리자</li><?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <th scope="col">제목</th>
                                        <th scope="col" class="mo_hide">이름</th>
                                        <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜</a></th>
                                        <th scope="col" class="mo_hide"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회</a></th>
                                        <?php if ($is_good) { ?><th scope="col"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천</a></th><?php } ?>
                                        <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천</a></th><?php } ?>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                                        ...
                                        <td class="td_name sv_use mo_hide"><?php echo $list[$i]['name'] ?></td>
                                        <td class="td_date"><?php echo $list[$i]['datetime2'] ?></td>
                                        <td class="td_num mo_hide"><?php echo $list[$i]['wr_hit'] ?></td>
                                        <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
                                        <?php if ($is_nogood) { ?><td class="td_num"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
                                    </tr>
                                    <?php } ?>
                                    <?//php if (count($list) == 0) { echo '<tr><td colspan="'.$colspan.'" class="empty_table">No announcement yet.</td></tr>'; } ?>
