	...
	<div id="container">
		...
		<section id="wrapper">
              ...
              <br>
                  ...
                  <button type="button" onclick="mob_bottom_pop('');">팝업등록</span>
							</div>
					</form>
				</article>
			</section>
...
$(document).ready(function() {
		mobbottom_search_act();
	});
function mob_bottom_pop(val){
  location.href="mobbottomView.php?top_menu_id="+top_menu_id+"&left_menu_id="+left_menu_id+"&seq="+val;
}

function mobbottom_search_act(){
	var page_division = "mbPop";
	var curpage = "1";
...
function showPaing(page_division,searchKey_1,searchVal_1,searchKey_2,searchVal_2,curpage,dtype) {
	        $.ajax({
	            type: "GET",
	            url: "./mobbottomList_paging_ajax.php",
							data: {
										 page_division : page_division,
										 searchKey_1 : searchKey_1,
										 searchVal_1 : searchVal_1,
...
function mobbottom_del(val1){
        var division = 'mobbottomdelete';
