...
$total_sql = "SELECT COUNT(*) as TotalNum FROM $POPUPITEM
							WHERE 1=1
							$searchVal_1_str
";
// echo "
...
if ($total_page > 0 && $page > 1) {
    $go_page = $page - 1;
    $html .= "<a href='#' onclick=\"showTable('" . $page_division . "','" . $searchKey_1 . "','" . $searchVal_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "', '" . $go_page . "', '" . $dtype . "')\">Previous</a>";
}
...
for ($page_link = $first + 1; $page_link <= $last; $page_link++) {
    if ($page_link == $page) {
        ...
        $html .= "<a href='#' onclick=\"showTable('" . $page_division . "','" . $searchKey_1 . "','" . $searchVal_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "','" . $page_link . "', '" . $dtype . "')\">" . $page_link . "</a>";
    }
}

if ($total_page > $page) {
    $go_page = $page + 1;
    $html .= "<a href='#' onclick=\"showTable('" . $page_division . "','" . $searchKey_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "','" . $searchVal_1 . "','" . $go_page . "', '" . $dtype . "')\">Next</a>";
}
