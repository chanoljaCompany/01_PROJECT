  ...
  <input type="hidden" name="pageId" id="pageId" value="<?=$pageId?>">
	<div id="pop_container2" class="pop_container2">
        ...
        <div id="pop_content2">
            ...
            <p class="dsc" id="info"><strong>1MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
		</form>
        <!-- //content -->
    </div>
    <div id="pop_container" class="pop_container" style="display:none;">
    	<!-- content -->
        <div id="pop_content">
	        <p class="dsc"><em id="imageCountTxt">0장</em>/10장 <span class="bar">|</span> <em id="totalSizeTxt">0MB</em>/10MB</p>
            ...
            <p class="dsc dsc_v1"><em>한 장당 1MB, 1회에 10MB까지, 10개</em>의 이미지 파일을<br>등록할 수 있습니다. (JPG, GIF, PNG, BMP)</p>
        </div>
        <!-- //content -->
    </div>
...
var SmEditor_url = './file_uploader_html5.php';
</script>
...
<script type="text/javascript" src="attach_photo.js?time=<?=time()?>" charset="utf-8"></script>
</body>
</html>
