						...
						<table class="tbl_col">
								...
								<thead>
									<tr>
										...
										<th scope="col" width="5%">접수일자</th>
										<th scope="col" width="10%">예약일자</th>
										<th scope="col" width="5%">결제일자</th>
										<th scope="col">상품명</th>
										<th scope="col" width="6%">예약자</th>
										<th scope="col" width="9%">연락처</th>
										<th scope="col" width="5%">결제수단</th>
										<th scope="col" width="5%">총결제금액</th>
