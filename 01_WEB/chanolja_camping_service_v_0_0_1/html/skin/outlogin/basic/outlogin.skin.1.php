...
<section id="ol_before" class="ol">
    ...
    <style>
        ...
        .tab_con_login div#login_tab { width: 350px; margin: 240px auto; padding: 35px; border: 1px solid #ccc; border-radius: 5px; }
        .tab_con_login div#login_tab .ol_wr {  }
        .tab_con_login div#login_tab .ol_wr > input { width: 100%; height: 45px; margin: 0 0 10px; padding: 5px; border: 1px solid #d0d3db; background: #f7f7f7; color: #000; vertical-align: middle; border-radius: 3px; }
        .tab_con_login div#login_tab .ol_wr > input#ol_id {  }
        .tab_con_login div#login_tab .ol_wr > input#ol_submit { padding: 8px 5px; font-size: 17px; font-weight: 600; color: #fff; background: #2f9cdf; }
        .tab_con_login div#login_tab .ol_auto_wr #ol_auto { display: inline-block; }
        .tab_con_login div#login_tab .ol_auto_wr #ol_svc { float: right; }
        .tab_con_login div#login_tab .ol_auto_wr #ol_svc a { display: inline-block; border: 1px solid #d5d9dd; color: #3a8afd; border-radius: 2px; padding: 2px 5px; line-height: 20px; }
        ...
        @media(max-width: 767px){
            #ol_be_cate { width: 100%; }
            #ol_be_cate ul.tab_login { width: 100%; border-bottom: 1px solid #eee; }
            #ol_be_cate ul.tab_login li { width: 25%; margin: 0 0 -1px; padding: 10px 0; font-size: 13px; text-align: center; background: #f7f7f7; border-right: 1px solid #eee; border-bottom: 1px solid #f3f3f3; float: left; cursor: pointer; }
            #ol_be_cate ul.tab_login li:nth-child(2) { border-right: 0; }
            #ol_be_cate ul.tab_login li.selected { color: #fff; background: #2f9cdf; }
            #ol_be_cate ul.tab_login li:hover { color: #fff; background: #2f9cdf; }

            .tab_con_login { width: 100%; }
            .tab_con_login div#login_tab { width: 100%; margin: 80px auto; border: 1px solid #eee; border-radius: 5px; }
            .tab_con_login div#login_tab .ol_wr {  }
            .tab_con_login div#login_tab > input { padding: 10px 5px; border: 1px solid #eee; }
            .tab_con_login div#login_tab > input.ol_submit { padding: 10px 5px; color: #333; }

            .tab_con_login div#register_tab { width: 100%; height: 480px; }
        }
