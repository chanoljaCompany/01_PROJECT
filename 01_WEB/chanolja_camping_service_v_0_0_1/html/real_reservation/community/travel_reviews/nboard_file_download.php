...
// js >>> $js <br>
// ";
$sql = " select * from {$NBOARD_BOARD_FILE_TB} where original_table = '$original_table' and seq = '$seq'";
$file = sql_fetch($sql);
...
$filepath = $board_upload_dir.$file['o_fileName'];
...
// {
    // 다운로드 카운트 증가
    $sql = " update  {$NBOARD_BOARD_FILE_TB}  set cnt = cnt + 1 where original_table = '$original_table' and seq = '$seq' and bf_no = '$no' ";
    sql_query($sql);
...
$original = urlencode($file['v_fileName']);
