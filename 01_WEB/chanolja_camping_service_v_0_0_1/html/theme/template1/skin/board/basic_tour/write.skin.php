...
<section id="bo_w">
  ...
  <div class="write_div">
	        ...
	        <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject"  required class="frm_input half_input required" placeholder="여행국가">
			...
			<select name="wr_6"  class="frm_input half_input required " required style='text-align:center'>
			<?php for($i=1; $i < 6; $i++) { ?>
