  ...
  <div class="inner">
    ...
    <div class="col-md-12  col-sm-12 col-xs-12">
        ...
        <!-- } 게시판 검색 끝 -->
            ...
            <left><font size=5px>02. 시도별 매장안내</font></left>
            <ul id="bo_cate_ul" style="width : 100px; border: 1px solid #cccccc;  -webkit-transition: .2s;  transition: .2s; padding: 0; border-radius : 5px; padding: 2px; margin: 4px;">
        ...
        function select_copy(sw) {
          ...
          function go_branch(city_do) {
            ...
            //alert(strArr[idx]);
            location.href="./board.php?bo_table=41&sca="+strArr[idx];
          }
