		...
		<div class="row">
    		...
    		<?php echo $page ?> page  
			 <?php if ($is_checkbox) { ?>
                	<div class="checkbox">
    					<label>
    						<input type="checkbox" id="chkall" onclick="if (this.checked) all_checked(true); else all_checked(false);"> 전체 체크
    					</label>
					</div>
            <?php } ?>
            </div>
		...
		<div class="col-lg-4 col-md-4 col-sm-6">	
			...
			<div class="astute-single-blog_mg">						
				...
				<!-- BLOG THUMB -->
						...
						<div class="astute-blog-thumb_adn ">
							<a href="<?php echo $list[$i]['href'] ?>">
                                ...
                                <?php } else {
                                    ...
                                    if($thumb['src']) {
                                        $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" style="height:280px;">';
                                    } else {
                                        $img_content = '<img src="'.G5_THEME_URL.'/assets/images/blog2.jpg" style="height:280px;">';
                                    }
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" style="display: block;text-align: center;margin-top: 15px;padding: 10px 0;background: #1ebdbd;color: #fff;">수정</a>

                     <?php } ?>
                    <!--
					<div class="em-blog-content-area_adn ">
						<p><i class="fa fa-user"></i> Name : <?php echo $list[$i]['name'] ?></p>
                        <p><i class="fa fa-calendar"></i> Date : <?php echo $list[$i]['datetime2'] ?></p>
                        <p><i class="fa fa-check" aria-hidden="true"></i> View : <?php echo $list[$i]['wr_hit'] ?></p>
...
-->
		...
		<?php }?>
		 <?php if (count($list) == 0) { echo "<div class=\"col-md-12 text-center\">No announcement yet.</div>"; } ?>
	 </div>
