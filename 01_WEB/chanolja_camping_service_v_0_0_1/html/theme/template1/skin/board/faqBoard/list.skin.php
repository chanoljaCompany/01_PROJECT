    	...
    	<div class="col">
			<div class="toggle toggle-primary" data-plugin-toggle>
            	...
            	<section class="toggle">
            		<label><?php echo strip_tags(conv_content($val['wr_subject'], 1)) ?></label>
            		<p style="height:0px;"><?php echo strip_tags(conv_content($val['wr_content'], 1)) ?></p>
            	</section>
            	<?php endforeach; ?>
            	<?php if (count($list) == 0) { echo '<label>게시물이 없습니다.</label>'; } ?>
            </div>    	
    	</div>
    </div>
    <?php endif; ?>
