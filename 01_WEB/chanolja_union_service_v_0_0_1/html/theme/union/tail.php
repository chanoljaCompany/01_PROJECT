...
-->
        ...
        <div id="ft_contact">
            <font size="5px">협동조합 가입문의</font><br>
            <strong>041 -522 - 7000</strong>
            <p><font color=#888>평일 : 09:00 - 18:00<br />(점심시간 12:30 - 13:30 / 주말, 공휴일 휴무)</font></p>
        </div>
        <div id="ft_link">
            <a href="http://chanolja-union.kr/bbs/content.php?co_id=company">회사소개</a>
            <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=privacy">개인정보보호정책</a>
            <a class="ft_link3" href="<?php echo G5_BBS_URL; ?>/content.php?co_id=provision">서비스 이용약관</a>
        </div>
        
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : 차놀자협동조합</li>
                <li class="ft_company2">대표 : 전은태</li>
                <li class="ft_company3">주소 : 충청남도 천안시 동남구 충절로 224, 1층 102호(원성동)</li>
                <li class="ft_company4">메일 : jet1118@naver.com</li>
                <li class="ft_company5">사업자등록번호 : 694-81-02025</li>                
            </ul>
        </div>
        
        <div id="ft_copy">
            Copyright &copy; <b>차놀자협동조합</b> <span>All rights reserved.</span>
        </div>
    </div>
