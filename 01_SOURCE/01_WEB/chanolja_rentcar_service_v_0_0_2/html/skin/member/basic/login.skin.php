...
<div id="mb_login" class="mbskin"
    ...
    <a href='http://testsv.dothome.co.kr'>
    	<img style="position:absolute; top: -95px; right:55px;" class=“logo_i” src=http://testsv.dothome.co.kr/theme/template1/img/logo.png>
    </a>
    <style>
        #back_btn{
            color: #3a8afd;
