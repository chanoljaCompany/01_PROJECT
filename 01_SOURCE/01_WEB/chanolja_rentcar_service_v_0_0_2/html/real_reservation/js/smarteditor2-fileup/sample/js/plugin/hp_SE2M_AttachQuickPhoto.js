...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){
		this.htPopupOption.sUrl = this.makePopupURL(this.oApp.pageId);
	 ...
	 */
	makePopupURL : function(pageId){
    //김유혁수정
    // var sPopupUrl = "./sample/photo_uploader/photo_uploader.html?pageId="+pageId;
    var sPopupUrl = "../../smEditor/content_uploader.php?pageId="+pageId;
		return sPopupUrl;
	},
