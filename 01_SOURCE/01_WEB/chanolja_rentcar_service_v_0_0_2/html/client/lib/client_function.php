...
function reserve_possible($startDate,$guestroom_code){
  global $GUESTROOM_RESERVATION_INFO_TB,$SITENAME;
...
//           ";
          ...
          if($peak_date) { //성수기
            if($holiday) { //공휴일
                // $pType = "ph";
                $room_fee_all += $rows['guestroom_fee_all_day'];
            ...
            if($holiday) { //공휴일
              $room_fee_all += (int)$rows['guestroom_fee_all_day'];
               $room_fee += (int)$rows['guestroom_semi_peak_season_fee_holiday'];
            }
            else if($holiday_prv){ //공휴일전날 -> 공휴일요금.
              $room_fee_all += (int)$rows['guestroom_fee_all_day'];
                $room_fee += (int)$rows['guestroom_semi_peak_season_fee_holiday'];
              ...
              if($weekDay) { //주말
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
               $room_fee += (int)$rows['guestroom_semi_peak_season_fee_weekend'];
              }
              else if($weekDay_sub){ //공휴일전날 -> 공휴일요금.
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
                  $room_fee += (int)$rows['guestroom_semi_peak_season_fee_weekend'];
                ...
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
               $room_fee += (int)$rows['guestroom_semi_peak_season_fee_weekday'];
              }
            }
          }
          else{  //비수기
            if($holiday) { //공휴일
                ...
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
				$room_fee += (int)$rows['guestroom_low_season_fee_holiday'];
            }
            else if($holiday_prv){ //공휴일전날 -> 공휴일요금.
                //$room_fee += $rows['guestroom_low_season_fee_holiday'];
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
              ...
              if($weekDay) { //주말
                //$room_fee += (int)$rows['guestroom_low_season_fee_weekend'];
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
				        $room_fee += (int)$rows['guestroom_low_season_fee_weekend'];
              }
              else if($weekDay_sub){ //공휴일전날 -> 공휴일요금.
                ...
                //$room_fee += (int)$rows['guestroom_low_season_fee_weekday'];
                $room_fee_all += (int)$rows['guestroom_fee_all_day'];
				$room_fee += (int)$rows['guestroom_low_season_fee_weekday'];
    ...
    $arrData = array(
                  ...
                  'guestroom_fee_all_day' => $rows['guestroom_fee_all_day'],
                ...
                'F_efficiency' => $rows['F_efficiency'],
