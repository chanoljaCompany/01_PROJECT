...
<?php
    ...
    $html .= "<li class='sct_li col-row-3' data-css='nocss' style='height:auto'>
              ...
              <div class='sct_sub_txt_wrap'>
                  <ul class='sct_sub_ul'>
                      <li><span> <i class='fas fa-map-marker-alt'></i> 연식 : ".$value['car_year']."</span></li>
                      ...
                      <li><span> <i class='fas fa-bed'></i> 유종 ".$value['fuel']."</span></li>
                      <li><span> <i class='fas fa-bed'></i> 기어 ".$value['transmission']."</span></li>                      
