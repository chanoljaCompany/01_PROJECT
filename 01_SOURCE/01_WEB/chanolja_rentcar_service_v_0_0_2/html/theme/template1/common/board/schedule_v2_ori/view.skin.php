...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title" style="display:inline-block">
            <?php
            if ($category_name) echo $view['ca_name'].' | '; // 분류 출력 끝
            echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력
			echo " (".substr($view['wr_1'],4,2)."/".substr($view['wr_1'],6,2)." ~ ".substr($view['wr_2'],4,2)."/".substr($view['wr_2'],6,2).")";
            ?>
        </h1>
		   <span class="sound_only" >작성일</span><strong style="float:right ; padding-top:13px;"><?php echo date("y-m-d ", strtotime($view['wr_datetime'])) ?></strong>
    </header>
