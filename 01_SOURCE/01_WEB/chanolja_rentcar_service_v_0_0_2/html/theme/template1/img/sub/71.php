<style type="text/css">
    ...
    .sch_box .sch_pop.sch_check .sch_checkbox {margin-top: 10px;max-height:180px;overflow: auto;}
...
<div class="subpage">
    <div class="sch_box">
        <div class="sch_tit">
            <h2>캠핑카, 간편하게 예약 후 바로 떠나세요!</h2><br>
            <h2>현재 캠핑카 에약은 전화를 통해 수동예약중입니다. </h2><br>
            <h2>예약문의 ▶ 010-2485-7220 ◀</h2>
