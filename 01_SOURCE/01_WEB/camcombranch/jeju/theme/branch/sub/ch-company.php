...
$g5['navTitle'] = "차놀자캠핑";
$g5['title'] = "기업소개";
$g5['sub-text']="안녕하세요. 차놀자캠핑 제주지점입니다.";
?>
                ...
                <div class="sec3-lt">
                    ...
                    <ul>
                        <li class="on" data-img="<?php echo G5_THEME_URL?>/img/sub/011.jpg">
                            <dl>
                                <dt>바다와 역사가 어우러진 <span><i class="xi-angle-down-min"></i></span></dt>
                                <dd>푸른 바다와 우리의 역사가 어우러진 캠핑, <br/>
                                    제주지점에서 특별한 휴식을 즐겨보세요.
                                </dd>
                            </dl>
                        </li>
                        <li data-img="<?php echo G5_THEME_URL?>/img/sub/012.jpg">
                            <dl>
                                 <dt>푸른 자연 속에서의 휴식<span><i class="xi-angle-down-min"></i></span></dt>
                                <dd>제주의 자연과 함께하는 특별한 여정, <br/>
                                    캠핑카 제주지점에서 만나보세요.
                                </dd>
                            </dl>
                        </li>
