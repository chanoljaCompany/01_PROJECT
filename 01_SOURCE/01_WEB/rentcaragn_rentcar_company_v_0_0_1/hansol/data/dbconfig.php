...
define('G5_MYSQL_USER', 'rentcaragn');
define('G5_MYSQL_PASSWORD', 'aqws1793!');
define('G5_MYSQL_DB', 'rentcaragn');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'hansol_');

define('G5_TOKEN_ENCRYPTION_KEY', 'ba73f437a92b08c1befc718d2c00098c'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'hansol_shop_');
