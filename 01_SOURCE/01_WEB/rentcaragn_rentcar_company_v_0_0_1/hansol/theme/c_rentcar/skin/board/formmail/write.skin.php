...
<section id="bo_w" style="margin: 0 auto; margin-top : 150px; width: 1200px;">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            <select id="wr_subject">
                    <option value="사고대차">사고대차</option>
                    <option value="단기렌트">단기렌트</option>
                    <option value="장기렌트">장기렌트</option>
                    <option value="신차렌트">신차렌트</option>
                </select>
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="예약날짜">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="장소">
    ...
    <div class="btn_confirm write_div">
        <a href="http://rentcaragn.dothome.co.kr/branch/hansol/bbs/write.php?bo_table=formmail" class="btn_cancel btn">다시 작성</a>
        <button type="submit" id="btn_submit" accesskey="s" class="btn_submit btn">예약하기</button>
    </div>
    </form>
