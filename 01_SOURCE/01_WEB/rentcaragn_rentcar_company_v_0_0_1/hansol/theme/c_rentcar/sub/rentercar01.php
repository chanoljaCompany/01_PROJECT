...
<body>
 ...
 <br>
        <h2 id="tit">운전자격</h2>
        	<div id="pro">
            	<div id="num">01</div>
                <div id="bac">도로교통법상 유효한 운전면허 소지자</div>
                <div id="clbt"></div>
            </div>
            <div id="pro">
            	<div id="num">02</div>
                <div id="bac">운전자 연령 : 만 21세이상 운전경력 1년이상 (일부 차종은 만 26세이상)</div>
                <div id="clbt"></div>
            </div>
            <div id="pro">
            	<div id="num">03</div>
                <div id="bac">승용차, 9인승 승합차 : 2종 보통면허 이상</div>
                <div id="clbt"></div>
            </div>
            <div id="pro">
            	<div id="num">04</div>
        ...
        <div id="h80"></div>
        <h2 id="tit">보험 및 보상</h2>
        	<div id="pro">
            	<div id="num">01</div>
                <div id="bac">차놀자렌터카의 모든 대여차량은 종합보험에 가입되어 있으므로 안심하셔도 됩니다.</div>
                <div id="clbt"></div>
            </div>
            <div id="pro">
            	<div id="num">02</div>
                <div id="bac">자동차 종합보험(대인, 대물, 자손) 자차 미가입</div>
                <div id="clbt"></div>
            </div>
            <div id="pro">
            	<div id="num">03</div>
                <div id="bac">보험처리 불가한 경우<br>
                - 음주운전 및 약물중독 운전사고<br>
                - 계약자와 제 2운전자 이 외의 운전자가 사고난 경우<br>
                - 범죄의 목적으로 렌트카 대여 중 발생한 사고<br>
                - 임차인의 부주의로 인한 도난사고<br>
                - 무면허 운전자</div>
                <div id="clbt"></div>
            </div>
