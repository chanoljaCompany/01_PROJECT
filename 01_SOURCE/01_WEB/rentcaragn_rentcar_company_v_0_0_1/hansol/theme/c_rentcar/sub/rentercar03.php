...
#pro #clbt {clear:both;}
#pro #center {width:50%;margin:30px auto 0;text-align:center;}
...
#pro #van01 {max-width:1020px; margin:30px auto 0; display: flex; flex-wrap: wrap; justify-content: center;}
#pro #van01 div { border:2px solid #207ad1; border-radius:20px; padding:30px 0; box-sizing:border-box; width:320px; min-height:300px; text-align:center; float:left; margin:0 10px; font-size:18px; line-height:35px; color:#888; margin-bottom: 30px;}
...
<body>
 ...
 <br>
 <br>
 <h2 id="tit">승합콜 특장점</h2>
        	<div id="pro">
            	<div id="num">01</div>
                <div id="bac">콜밴 대체 사업인 승합콜은 미래지향적인 사업으로 대한민국의 새로운 대중교통입니다.</div>
                <div id="clbt"></div>
                <div id="van01">
                	<div><h2>2000년 초 (과거)</h2>
                    콜밴<br>
                    500대 가량<br>
                    카니발<br>
                    콜서비스</div>
            ...
            <div id="pro">
            	<div id="num">02</div>
                <div id="bac">카니발과 스타렉스를 최적의 품질과 최저요금으로 적기에 제공해주는 서비스입니다.<br>( 절차 : 지점계약 &gt; 기사모집 &gt; 광고홍보 &gt; 운영 &gt; 수익 )</div>
                <div id="clbt"></div>
                <div id="center">
<!--                    <img src="/img/page/vanBsns.png" style="width : 80%;">-->
                    <table style="width: 100%; margin: 0 auto; border-radius: 10px; height: 500px; font-size: 25px; max-width: 1240px;">
                        <tbody>
                            <tr>
                                <td style="border-radius: 20px; background-color: #207ad1; color: white; border: 1px solid #207ad1;">승합콜 사업</td>
                            </tr>
                            <tr>                 <td style="border: 1px solid #207ad1; border-radius: 20px;">고객</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #207ad1;">콜센터</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #207ad1;">카카오맵</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #207ad1;">렌터카(카니발, 스타렉스)</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #207ad1;">대리운전기사(용역)</td></tr>
                        </tbody>
            ...
            <div id="pro">
            	<div id="num">03</div>
                <div id="bac">승합콜은 다양한 분야의 고객층이 있어 다양한 형태로 사업이 가능합니다.</div>
                <div id="clbt"></div>
            ...
            <div id="pro">
            	<div id="num">04</div>
                <div id="bac">승합콜은 인원이 많을 경우 택시와 비교 하였을 때, 다양한 장점이 있습니다.</div>
                <div id="clbt"></div>
                <table id="van04" cellspacing="0" cellpadding="0">
                	...
                	<thead>
                        ...
                        <tr>
                        	<td>법규정 개편</td>
                            <td></td>
                            <td>기사+렌터카 11~15인승 이하</td>
                        </tr>
                </tbody></table>
            </div>
            <div id="pro">
            	<div id="num">05</div>
                <div id="bac">단발성으로 운영하실 경우 부가세 100% 환급 및 차량판매매 수수료의 혜택이 있으며,<br>
                지속적으로 운영하실 경우 운영관리비 및 콜비수수료를 지급받으 실 수 있습니다.<br>
                ( 지점요건 : 사무실, 주차장, 기사모집, 지입기사, 보증보험증권, 담보 )</div>
                <div id="clbt"></div>
            </div>
