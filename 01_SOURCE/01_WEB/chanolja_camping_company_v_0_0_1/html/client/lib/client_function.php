...
function get_goption_all($guestroom_code,$option_type,$user_id){
  ...
  $sql = "SELECT A.*,B.*
          ...
          WHERE 1=1 
          AND A.guestroom_code='$guestroom_code'
...
//   area,basicoption,sPrice,ePrice,driver_license
  ...
  $sql = "SELECT DISTINCT A.* , B.guestroom_image_name
          ...
          WHERE 1=1
          AND A.guestroom_type = '".$divisionType."'
          $sub_qry
          AND A.post_show = 'Y'
...
//           ";
    ...
    $arrData = array(
              ...
              'guestroom_low_season_fee_weekday' => (int)$rows['guestroom_low_season_fee_weekday'],
              'guestroom_low_season_fee_weekend' => (int)$rows['guestroom_low_season_fee_weekend'],
              'guestroom_low_season_fee_holiday' => (int)$rows['guestroom_low_season_fee_holiday'],
...
function get_reserve_confirm_data($rname,$rphone) { //예약정보
  ...
  $sql = "SELECT * FROM $GUESTROOM_RESERVATION_TB
          WHERE 1=1
          AND guestroom_reserve_user_name = '".$rname."'
...
function get_image_array($get_guestroom_code) {
    ...
    $sql = "SELECT *
            ...
            WHERE 1=1
            AND guestroom_code = '".$get_guestroom_code."'
            ";
    //         echo "
    // $sql
    //         ";
