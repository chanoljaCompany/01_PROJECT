...
$g5['navTitle'] = "차놀자캠핑";
$g5['title'] = "기업소개";
$g5['sub-text']="안녕하세요. 국내최대/최다 캠핑카 기반 여행플랫폼 차놀자캠핑입니다.";
?>
                ...
                <div class="sec3-lt">
                    ...
                    <ul>
                        <li class="on" data-img="<?php echo G5_THEME_URL?>/img/sub/011.jpg">
                            <dl>
                                <dt>국내최대캠핑카 <span><i class="xi-angle-down-min"></i></span></dt>
                                <dd>전국 50여개 지점과 180여대의 캠핑카 대여 인프라를 바탕으로.<br>
                                    캠핑카 기반 종합여행 서비스를 제공합니다.
                                </dd>
                            </dl>
                        </li>
                        <li data-img="<?php echo G5_THEME_URL?>/img/sub/012.jpg">
                            <dl>
                                 <dt>캠핑여행의 리더<span><i class="xi-angle-down-min"></i></span></dt>
                                <dd>캠핑인구 700만을 돌파하는 캠핑여행의 시대입니다.<br>
                                    캠핑여행을 위한 다양한 서비스로 캠핑여행을 선도합니다.
                                </dd>
                            </dl>
                        </li>
