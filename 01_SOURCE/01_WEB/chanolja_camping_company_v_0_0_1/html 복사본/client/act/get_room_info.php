...
if ($division == 'getData') {
  ...
  $room_info_array_etc = "";
  $room_info_array_etc = room_info_array_etc(
    $get_guestroom_code,
    $dateStr,
    $divisionType,
    $personnel,
  ...
  foreach ($room_info_array_etc as $key => $value) {
    ...
    $html .= "<li class='sct_li col-row-3' data-css='nocss' style='height:auto'>
                  ...
                  <div class='sct_sub_txt_wrap'>
                      ...
                      <div class='sct_sub_txt'><span><i class='far fa-calendar-check'></i> " . number_format($value['room_fee']) . "원(" . $value['dateintval'] . "박)</span></div>
                  </div>
