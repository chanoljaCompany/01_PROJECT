	...
	<div id="sit_tab">
	    ...
	    <ul class="tab_con">
	        ...
	        <li id="sit_inf">
                ...
                <h4 id="sit_title"><?php echo stripslashes($it['it_name']); ?> <span class="sound_only">요약정보 및 구매</span></h4>
	            <p id="sit_desc"><?php echo $it['it_basic']; ?></p>
                <!-- 상품기본정보 시작 -->
                <div class="sit_ov_info">
                    <div class="sit_ov_content">
                        <h5>캠핑카 소개</h5>
                        <p>
                        안녕하십니까 지에스캠핑카 입니다. 차별화된 서비스로 고객님을 모십니다. 국내유일 전국무료 딜리버리 서비스를 해드리며 화장실 이용후 오물처리는 회사에서 처리하오니 부담없이 사용하시면 됩니다. 
                        또한 기본 캠핑장비(4인용 테이블,의자4개)와 세면도구(치약,칫솔,비누,샴푸,린스)4인기준 제공,수건,헤어드라이기,휴지,물티슈,양념통,조리도구,코펠,버너,화로대 등을 무료로 제공해드리오니 많은 이용바랍니다. 
                        감사합니다.<br>
                        *평일예약은 2박이상만 가능합니다.*
                        </p>
                    </div>
                    <div class="sit_ov_content">
                        <h5>상세 정보</h5>
                        <ul class="sit_ov_list">
                            <li>동승가능인원: 5명</li>
                            <li>취침가능인원: 5명</li>
                        </ul>
                        <ul class="sit_ov_list">
                            <li>대여일 출차시간 09:00</li>
                            <li>반납일 반납시간 19:00</li>
                        </ul>
                        <ul class="sit_ov_list">
                            <li>평일 가격: 280,000원 /박</li>
                            <li>주말 가격: 380,000원 /박</li>
                        </ul>
                        <ul class="sit_ov_list">
                            <li>만 26세 이상</li>
                            <li>2종 보통 이상</li>
                        ...
                        <ul class="sit_ov_list">
                            <li>차고지 주소: 대한민국 인천광역시 부평구 부평대로 283</li>
                        </ul>
                    </div>
                    <div class="sit_ov_content">
                        <h5>딜리버리(탁송) 가능지역</h5>
                        <p>
                            경기도 안양/군포/의왕/과천 : 편도 2만원<br>
                            그 외 전 지역 : 편도 3만원 부터 (별도 문의)
                        </p>
                    </div>
                    <div class="sit_ov_content">
                        <h5>보유시설</h5>
