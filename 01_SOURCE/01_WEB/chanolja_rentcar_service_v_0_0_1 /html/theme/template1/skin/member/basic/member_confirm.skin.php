...
<div id="mb_confirm" class="mbskin">
    ...
    <form name="fmemberconfirm" action="<?php echo $url ?>" onsubmit="return fmemberconfirm_submit(this);" method="post" class="form-inline">
    ...
    <fieldset>
        ...
        <input type="submit" value="확인" id="btn_submit" class="astute_btn" style="padding:3px 5px;margin:0px;">
    </fieldset>
