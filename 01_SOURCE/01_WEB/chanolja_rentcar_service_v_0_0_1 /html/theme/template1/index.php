   ...
   <div class="box inner">
        <div class="detail">
            <ul class="clearfix">
                ...
                <li class="wow bounceInUp" data-wow-delay="0.5s">
                    <a href="#"><img src="<?php echo G5_THEME_IMG_URL ?>/icon/top_icon3.png" style="margin-right : 60px; width:192px; border-radius: 20px;  box-shadow: 0 10px 30px -10px rgba(0, 0, 0, .35); opacity:1;" ></a>

                </li>
                <li class="wow bounceInUp" data-wow-delay="0.5s">
                    <a href="http://www.chanolja.co.kr/"><img src="<?php echo G5_THEME_IMG_URL ?>/icon/top_icon4.png" style="margin-right : 60px; width:192px; border-radius: 20px;  box-shadow: 0 10px 30px -10px rgba(0, 0, 0, .35); opacity:1;" ></a>
                </li>
                <li class="wow bounceInUp" data-wow-delay="0.5s">
...
<div class="aboutWrap">
   <div class="box inner">
		<div class="main_title">
			...
			<a href="http://testsv.dothome.co.kr/bbs/board.php?bo_table=51"><h5 class="wow fadeInDown" data-wow-delay="0.4s">전체보기</h5></a>
        </div>
        <div class="detail">
       <?php
   ...
   <div class="box inner">
        <div class="detail">
            <ul class="clearfix">
                ...
                <li class="wow bounceInUp" data-wow-delay="0.5s">
                    <a href="#"><img src="<?php echo G5_THEME_IMG_URL ?>/icon/top_icon3.png" style="width:90px;margin-left : 5px; margin-right : 5px; border-radius: 20px;  box-shadow: 0 10px 30px -10px rgba(0, 0, 0, .35); opacity:1;" ></a>
                </li>
                    </ul>
        </div>
        <div class="detail">
