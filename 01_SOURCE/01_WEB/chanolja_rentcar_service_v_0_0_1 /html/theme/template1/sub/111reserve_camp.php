...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jQuery-rwdImageMaps/1.6/jquery.rwdImageMaps.min.js"></script>
    ...
    width: 100%;">
        <img src="http://www.chanolja.co.kr/theme/template1/img/%EC%98%88%EC%95%BD%EB%AC%B8%EC%9D%98.jpeg" 
            style="    width: 100%;
                        max-width: 600px;
            }" usemap="#image-map">

        <map name="image-map">
            <area target="" alt="" title="" onclick="document.location.href='tel:1811-6526'" coords="573,368,30,153" shape="rect">
            <area target="" alt="" title="" onclick="document.location.href='http://chatour.dothome.co.kr/bbs/board.php?bo_table=52';" coords="30,431,572,619" shape="rect">
        </map>
    </div> -->
    <script>
        $(document).ready(function() {
            // $('.creating_box img[usemap]').rwdImageMaps();
