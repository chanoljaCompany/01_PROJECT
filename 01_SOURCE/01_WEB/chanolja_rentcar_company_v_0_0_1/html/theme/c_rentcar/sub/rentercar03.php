...
#pro #van01 div { border:2px solid #13568D; border-radius:20px; padding:30px 0; box-sizing:border-box; width:320px; min-height:300px; text-align:center; float:left; margin:0 10px; font-size:18px; line-height:35px; color:#888; margin-bottom: 30px;}
...
<!--                    <img src="/img/page/vanBsns.png" style="width : 80%;">-->
                    <table style="width: 100%; margin: 0 auto; border-radius: 10px; height: 500px; font-size: 25px; max-width: 1240px;">
                        <tbody>
                            <tr>
                                <td style="border-radius: 20px; background-color: #13568d; color: white; border: 1px solid #13568d;">승합콜 사업</td>
                            </tr>
                            <tr>                 <td style="border: 1px solid #13568d; border-radius: 20px;">고객</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #13568d;">콜센터</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #13568d;">카카오맵</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #13568d;">렌터카(카니발, 스타렉스)</td></tr>
                            <tr>                 <td style="border-radius: 20px; border: 1px solid #13568d;">대리운전기사(용역)</td></tr>
                        </tbody>
