...
<section id="bo_w">
    ...
    <div class="write_div">
        <label for="wr_2" class="sound_only">가격<strong class="sound_only">필수</strong></label>
        <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2"  required class="frm_input full_input" placeholder="가격">
    </div>
    
    <div class="bo_w_tit write_div">
    	<textarea name="wr_1" id="wr_1" required rows="5" class="frm_input" style="height:200px" placeholder="설명"><?php echo $write['wr_1'] ?></textarea>
    </div>
