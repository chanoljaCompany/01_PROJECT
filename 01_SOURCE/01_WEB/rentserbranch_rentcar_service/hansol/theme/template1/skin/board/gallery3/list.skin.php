...
<!--         <div id="bo_list_total">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($admin_href) { ?><li><a href="/adm/board_form.php?w=u&bo_table=010401&sst=a.gr_id,a.bo_table&sod=asc&sfl=&stx=&page=1" class="btn_admin">창업지원</a></li><?php } ?>
  ...
  //if (isset($list[$i]['icon_file'])) echo $list[$i]['icon_file'];
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="/bbs/write.php?bo_table=010401" class="btn_b02">창업지원 글쓰기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
