...
.cke_sc {display:none;}
    ...
    <div class="form-row">
		<div class="form-group col-lg-3">
			<label for="wr_1">시작일</label>
			<input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" readonly id="wr_1" class="form-control" size="8" maxlength="8">
		</div>
		<div class="form-group col-lg-3">
			<label for="wr_2">시작일</label>
			<input type="text" name="wr_2" value="<?php echo $write['wr_2']; ?>" readonly id="wr_2"  class="form-control" size="8" maxlength="8">
		</div>
	</div>
    ...
    <script>
    $(function(){ // 날짜 입력
		$("#wr_1, #wr_2").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true }); 
	});
