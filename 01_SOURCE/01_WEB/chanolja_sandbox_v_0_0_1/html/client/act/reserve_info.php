...
//  }
  ...
  $html .= "<div class='top_notice'>
                ...
                if($reserveData['guestroom_reserve_payment_method'] == '1'){
                    $html .= "<p><i class='fa fa-exclamation-circle' aria-hidden='true'></i> <font color='red'>인터넷 예약 특성상 입금시간이 지체되면 예약이 중복될수 있어 빠른입금 부탁드립니다. </font></p>
                <p><i class='fa fa-exclamation-circle' aria-hidden='true'></i> <font color='red'>입금완료 후 예약확정을 위해 빠르게 통화하시는것이 좋습니다.</font></p>";
                }
                $html .= "</div>";
  if($conType == '1'){ //모바일
