...
function captcha_html($class="captcha")
{
    ...
    if (is_mobile()) $html .= '<audio style="margin-bottom:10px" id="captcha_audio" controls></audio>';
    //$html .= "\n".'<img src="#" alt="" id="captcha_img">';
    $html .= "\n".'<img src="'.G5_CAPTCHA_URL.'/img/dot.gif" style="margin-bottom:10px" alt="" id="captcha_img">';
    $html .= '<input type="text" name="captcha_key" id="captcha_key" style="margin-bottom:10px; width:75%" required class="captcha_box required" size="6" maxlength="6">';
    if (!is_mobile()) $html .= "\n".'<button type="button" id="captcha_mp3"><span></span>숫자음성듣기</button>';
    $html .= "\n".'<button type="button" id="captcha_reload"><span></span>새로고침</button>';
    $html .= "\n".'<span style="margin-bottom:10px" id="captcha_info">자동등록방지 숫자를 순서대로 입력하세요.</span>';
    $html .= "\n".'</fieldset>';
    return $html;
}
