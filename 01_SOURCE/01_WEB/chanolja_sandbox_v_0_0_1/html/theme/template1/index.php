...
<div class="aboutWrap" style="margin-bottom: 20px !important; margin-top: 20px;">
   <div class="box inner" style="padding : 0px;">
    <div class="detail">
              <a href="http://sandbox1.dothome.co.kr/bbs/board.php?bo_table=70" style="display:flex; position:relative;">
...
<div class="aboutWrap_mo" style="margin-bottom: 20px !important; ">
   <div class="box inner" style="padding : 0px;">
    <div class="detail">
              <a href="sandbox1.dothome.co.kr/bbs/board.php?bo_table=70" style="display:flex; position:relative;">
...
<div class="aboutWrap">
    <div class="box inner">
     		<div class="main_title">
               <h2 class="wow fadeInDown" data-wow-delay="0.4s">지에스렌트카가 추천하는 여행지</h2>
...
<div class="aboutWrap">
   <div class="box inner">
		<div class="main_title">
            <h2 class="wow fadeInDown" data-wow-delay="0.4s">신규 등록 캠핑카</h2>
...
<div class="aboutWrap">
   <div class="box inner">
		<div class="main_title">
            <h2 class="wow fadeInDown" data-wow-delay="0.4s">알려드립니다.</h2>
...
<div class="aboutWrap_mo">
    <div class="box inner">
     		<div class="main_title">
               <h2 class="wow fadeInDown" data-wow-delay="0.4s">지에스렌트카가 추천하는 캠핑여행지</h2>
		      <a href="http://www.chanolja.co.kr/bbs/board.php?bo_table=tour_guide"><h5 class="wow fadeInDown" data-wow-delay="0.4s">전체보기</h5></a>
            </div>
            <div class="detail">
...
<div class="aboutWrap_mo">
   <div class="box inner">
        <div class="utube_wrap"  style="max-width : 100%" >
                       <center> <font size=5><bold> 캠핑카 미디어 </bold></font></br>
                       <font size=3>#캠핑카 #캠핑카여행 #캠핑카사업 #캠핑카맡기기</font>  </center>
