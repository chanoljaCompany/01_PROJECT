...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div class="inner">
           ...
           <div id="tnb">
                <ul>
					<a href="<?php echo G5_URL ?>"><img class="logo_i" src="<?php echo G5_THEME_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
                    <a href="<?php echo G5_URL ?>"><img class="logo_m" src="<?php echo G5_THEME_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
                    <?php if ($is_member) {  ?>
            ...
            <script>
                ...
                function set_cookie(name, value, expire_days){
                    ...
                    today_date.setDate( (today_date.getDate() + expire_days) );

                    document.cookie = `${name}=${escape(value)}; path=/; expires=${today_date}`;
...
<!-- 콘텐츠 시작 { -->
<div id="wrapper"> <!-- template1\css\default.css 767미디어태그로 상위 60px, 90px 여백 -->
    <div id="container_wr">
