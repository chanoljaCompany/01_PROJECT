    ...
    <div class="inner">
        ...
        <div id="bo_btn_top">
            ...
            <ul class="btn_bo_user">
                ...
                <?php if ($is_admin) { ?><li style="display: flex; justify-content: flex-end;"><a href="<?php echo $write_href ?>" class="btn_b02 btn btn_write"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
        <!-- } 게시판 페이지 정보 및 버튼 끝 -->
