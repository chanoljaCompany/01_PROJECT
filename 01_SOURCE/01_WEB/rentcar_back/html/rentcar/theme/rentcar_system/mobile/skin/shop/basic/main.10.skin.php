...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    echo "<li class=\"sct_li{$li_clear}\"><div class=\"li_wr box\">\n";
    ...
    if ($this->view_it_name) {
        echo stripslashes($row['it_name'])."<br>\n";
        echo "<h6>\n";
		echo stripslashes($row['it_origin'])."식 \n", ($row['it_brand']). "\n";
        echo "</h6>\n";

    }
	    if ($this->view_it_price) {
        echo "<div class=\"sct_cost\" style=\"text-align:left ;font-size:1.3em;margin:5px 0; color : #df2d2d;\">\n";
