    ...
    <script type="text/javascript">
      function rsize() {
       var iframe = document.getElementById( 'inneriframe' );
        ...
        iframe.src = 'http://songcar.dothome.co.kr/sub/rentcar.php?height='+height;      }
     </script>
...
<!--
        ...
        <div id="hd_btn">
            ...
            <div class="btn_left">
                <button type="button" id="btn_cate"><i class="fa fa-bars"></i> <font size="4px">&nbsp;&nbsp;&nbsp;자동차 카테고리 </font></button>
            </div>
<!--
            <div class="btn_right">
                <?php if ($is_member) { ?>
