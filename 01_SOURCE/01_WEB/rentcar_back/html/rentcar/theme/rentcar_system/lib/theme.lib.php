...
function item_icon2($it)
{
    ...
    if ($it['it_type4'])
        $icon .= '<span class="icon icon_best">인기상품</span>';

    if ($it['it_type5'])
        $icon .= '<span class="icon icon_sale">7일 이내</span>';

    if ($it['it_type3'])
        $icon .= '<span class="icon icon_new">BEST</span>';

    if ($it['it_type1'])
        $icon .= '<span class="icon icon_hit">HOT SALE</span>';
