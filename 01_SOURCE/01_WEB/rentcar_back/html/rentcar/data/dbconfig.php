...
define('G5_MYSQL_USER', 'songcar');
define('G5_MYSQL_PASSWORD', 'aqws1793!');
define('G5_MYSQL_DB', 'songcar');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'rentcar_');

define('G5_TOKEN_ENCRYPTION_KEY', '485439f7067abd294e1730b199488fde'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'rentcar_shop_');
