...
<li><a href="#anc_sodr_list">계약신청 목록</a></li>
...
<section id="anc_sodr_list">
    ...
    <div class="btn_list02 btn_list" style="display:none">
        <p>
...
<?php if($od['od_test']) { ?>
<div class="od_test_caution" style="display:none">주의) 이 주문은 테스트용으로 실제 결제가 이루어지지 않았으므로 절대 배송하시면 안됩니다.</div>
<?php } ?>
...
<section id="anc_sodr_memo" style="display:none">
