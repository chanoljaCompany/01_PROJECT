...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_contact">
		    24시간 접수센터<br>
            <strong>1522 - 2625</strong> <br>
            일반근무시간<br>
			평일 : 09:00 - 18:00<br />(점심시간 12:30 - 13:30 / 주말, 공휴일 휴무)
        </div>
        <div id="ft_link">
            <a href="<?php echo G5_URL ?>/sub/company.php">회사소개</a>
        ...
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : 주식회사 차놀자렌터카</li>
                <li class="ft_company2">대표 : 장성민</li>
                <li class="ft_company3">주소 : 충청남도 공주시 백미고을길 10-9 3층</li>
                <li class="ft_company4">메일 : raver8@naver.com</li>
                <li class="ft_company5">자동차대여사업등록번호 : 제2500000-2019-01-00018호</li>
                <li class="ft_company6">통신판매업 신고번호 : <a href="javascript:;">[사업자정보확인]</a></li>
            </ul>
        </div>
        
        <div id="ft_copy">
            Copyright &copy; <b>(주)차놀자렌터카</b> <span>All rights reserved.</span>
        </div>
    </div>
