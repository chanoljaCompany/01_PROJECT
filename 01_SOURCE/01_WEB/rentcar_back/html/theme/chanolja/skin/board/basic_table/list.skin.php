...
<div id="bo_list" style="width:<?php echo $width; ?>">
    <div class="inner">
        ...
        <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" class="wow fadeInUp" data-wow-delay="0.3s">
