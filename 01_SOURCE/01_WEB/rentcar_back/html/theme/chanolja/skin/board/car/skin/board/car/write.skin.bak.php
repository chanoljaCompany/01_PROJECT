...
<? if ($is_notice || $is_html || $is_secret || $is_mail) { ?>
        ...
        <? if ($is_html) { ?><input onclick="html_auto_br(this);" type=checkbox value="<?=$html_value?>" name="html" <?=$html_checked?>>html &nbsp;<? } ?>
...
<table width="100%" cellspacing="2" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td><table width="100%" cellpadding="3" cellspacing="1" bgcolor="#EAEAEA" >
<tr bgcolor="#FFFFFF">
<td width="25%" bgcolor="#FFEFE8"><input type="checkbox" name="six05" value="1" <? if ($six05 == '1') echo "checked";?> /> 파워핸들</td>
<td width="25%" bgcolor="#FFFFFF"><input type="checkbox" name="six06" value="1" <? if ($six06 == '1') echo "checked";?> /> 가죽핸들</td>
<td width="25%" bgcolor="#FFEFE8"><input type="checkbox" name="six07" value="1" <? if ($six07 == '1') echo "checked";?> /> 가죽/우드핸들</td>
<td width="25%" bgcolor="#FFFFFF"><input type="checkbox" name="six08" value="1" <? if ($six08 == '1') echo "checked";?> /> 틸티핸들</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six09" value="1" <? if ($six09 == '1') echo "checked";?> /> 히팅핸들</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six10" value="1" <? if ($six10 == '1') echo "checked";?> /> 속도감응식핸들</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six11" value="1" <? if ($six11 == '1') echo "checked";?> /> 텔레스코픽핸들</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six12" value="1" <? if ($six12 == '1') echo "checked";?> /> 핸들리모콘</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six13" value="1" <? if ($six13 == '1') echo "checked";?> /> 가죽시트</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six14" value="1" <? if ($six14 == '1') echo "checked";?> /> 파워시트</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six15" value="1" <? if ($six15 == '1') echo "checked";?> /> 뒷좌석분할시트</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six16" value="1" <? if ($six16 == '1') echo "checked";?> /> 메모리시트</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six17" value="1" <? if ($six17 == '1') echo "checked";?> /> 통풍시트</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six18" value="1" <? if ($six18 == '1') echo "checked";?> /> 열선시트</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six19" value="1" <? if ($six19 == '1') echo "checked";?> /> 가죽팩</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six20" value="1" <? if ($six20 == '1') echo "checked";?> /> 파워도어록</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six21" value="1" <? if ($six21 == '1') echo "checked";?> /> 파워윈도우</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six22" value="1" <? if ($six22 == '1') echo "checked";?> /> 에어컨</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six23" value="1" <? if ($six23 == '1') echo "checked";?> /> 전자동 에어컨</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six24" value="1" <? if ($six24 == '1') echo "checked";?> /> 좌우독립에어컨</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six25" value="1" <? if ($six25 == '1') echo "checked";?> /> 운전석에어백</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six26" value="1" <? if ($six26 == '1') echo "checked";?> /> 조수석에어백</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six27" value="1" <? if ($six27 == '1') echo "checked";?> /> 사이드에어백</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six28" value="1" <? if ($six28 == '1') echo "checked";?> /> 커튼에어백</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six29" value="1" <? if ($six29 == '1') echo "checked";?> /> 헤드에어백</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six30" value="1" <? if ($six30 == '1') echo "checked";?> /> 무릎보호에어백</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six31" value="1" <? if ($six31 == '1') echo "checked";?> /> 승객감지에어백</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six32" value="1" <? if ($six32 == '1') echo "checked";?> /> 전동접이식미러</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six33" value="1" <? if ($six33 == '1') echo "checked";?> /> 냉장고</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six34" value="1" <? if ($six34 == '1') echo "checked";?> /> 자동도어잠금장치</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six35" value="1" <? if ($six35 == '1') echo "checked";?> /> 네비게이션</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six36" value="1" <? if ($six36 == '1') echo "checked";?> /> 알루미늄휠</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six37" value="1" <? if ($six37 == '1') echo "checked";?> /> 썬루프</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six38" value="1" <? if ($six38 == '1') echo "checked";?> /> 파노라마썬루프</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six39" value="1" <? if ($six39 == '1') echo "checked";?> /> 요추받침장치</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six40" value="1" <? if ($six40 == '1') echo "checked";?> /> 튜닝오디오</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six41" value="1" <? if ($six41 == '1') echo "checked";?> /> 튜닝알루미늄휠</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six42" value="1" <? if ($six42 == '1') echo "checked";?> /> 트립컴퓨터</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six43" value="1" <? if ($six43 == '1') echo "checked";?> /> 뒷좌석TV</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six44" value="1" <? if ($six44 == '1') echo "checked";?> /> 타이어압력표시장치</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six45" value="1" <? if ($six45 == '1') echo "checked";?> /> ECM룸미러</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six46" value="1" <? if ($six46 == '1') echo "checked";?> /> 제논라이트</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six47" value="1" <? if ($six47 == '1') echo "checked";?> /> 크루져컨트롤</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six48" value="1" <? if ($six48 == '1') echo "checked";?> /> 무선도어리모콘</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six49" value="1" <? if ($six49 == '1') echo "checked";?> /> 무선시동</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six50" value="1" <? if ($six50 == '1') echo "checked";?> /> 도난경보장치</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six51" value="1" <? if ($six51 == '1') echo "checked";?> /> 핸즈프리</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six89" value="1" <? if ($six89 == '1') echo "checked";?> /> VCD</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six53" value="1" <? if ($six53 == '1') echo "checked";?> /> 이지엑세스</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six54" value="1" <? if ($six54 == '1') echo "checked";?> /> 스키스루</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six55" value="1" <? if ($six55 == '1') echo "checked";?> /> 파크트로닉</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six56" value="1" <? if ($six56 == '1') echo "checked";?> /> 루프케리어</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six57" value="1" <? if ($six57 == '1') echo "checked";?> /> 전/후방 감지기</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six58" value="1" <? if ($six58 == '1') echo "checked";?> /> 후방감지모니터</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six59" value="1" <? if ($six59 == '1') echo "checked";?> /> 나이트비젼</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six60" value="1" <? if ($six60 == '1') echo "checked";?> /> 디스트로닉</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six61" value="1" <? if ($six61 == '1') echo "checked";?> /> 레인센서</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six62" value="1" <? if ($six62 == '1') echo "checked";?> /> 램프와이퍼/와셔</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six63" value="1" <? if ($six63 == '1') echo "checked";?> /> 롤오버바</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six64" value="1" <? if ($six64 == '1') echo "checked";?> /> 키리스엔트리시스템</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six65" value="전동소프트탑" <? if ($six65 == '전동소프트탑') echo "checked";?> /> 전동소프트탑</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six66" value="수동소프트탑" <? if ($six66 == '수동소프트탑') echo "checked";?> /> 수동소프트탑</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six67" value="탈착식하드탑" <? if ($six67 == '탈착식하드탑') echo "checked";?> /> 탈착식하드탑</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six68" value="전동하드탑" <? if ($six68 == '전동하드탑') echo "checked";?> /> 전동하드탑</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six69" value="1" <? if ($six69 == '1') echo "checked";?> /> 4WD</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six70" value="1" <? if ($six70 == '1') echo "checked";?> /> ABC</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six71" value="1" <? if ($six71 == '1') echo "checked";?> /> ABS</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six72" value="1" <? if ($six72 == '1') echo "checked";?> /> ASC</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six73" value="1" <? if ($six73 == '1') echo "checked";?> /> ASR</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six74" value="1" <? if ($six74 == '1') echo "checked";?> /> AQS</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six75" value="1" <? if ($six75 == '1') echo "checked";?> /> AV시스템</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six76" value="1" <? if ($six76 == '1') echo "checked";?> /> BAS</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six77" value="1" <? if ($six77 == '1') echo "checked";?> /> CD플레이어</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six78" value="1" <? if ($six78 == '1') echo "checked";?> /> CD체인져</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six79" value="1" <? if ($six79 == '1') echo "checked";?> /> 클로징 에이드</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six80" value="1" <? if ($six80 == '1') echo "checked";?> /> DSC</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six81" value="1" <? if ($six81 == '1') echo "checked";?> /> DTR</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six82" value="1" <? if ($six82 == '1') echo "checked";?> /> DVD</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six83" value="1" <? if ($six83 == '1') echo "checked";?> /> EBD</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six84" value="1" <? if ($six84 == '1') echo "checked";?> /> ECS</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six85" value="1" <? if ($six85 == '1') echo "checked";?> /> EDC</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six86" value="1" <? if ($six86 == '1') echo "checked";?> /> ESP</td>
<td bgcolor="#FFEFE8"><input type="checkbox" name="six87" value="1" <? if ($six87 == '1') echo "checked";?> /> GPS</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six88" value="1" <? if ($six88 == '1') echo "checked";?> /> TCS</td>
</tr>
<tr bgcolor="#FFFFFF">
<td bgcolor="#FFEFE8"><input type="checkbox" name="six92" value="1" <? if ($six91 == '1') echo "checked";?> /> 전동 햇빛가리개</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six90" value="1" <? if ($six90 == '1') echo "checked";?> /> 리어스포일러</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six91" value="1" <? if ($six91 == '1') echo "checked";?> /> 에어댐</td>
<td bgcolor="#FFFFFF"><input type="checkbox" name="six52" value="1" <? if ($six52 == '1') echo "checked";?> /> 스트릿바</td>
                          </tr>
                        </table></td>
                      </tr>
                  </table></td>
...
<tr bgcolor="ffffff">
<td bgcolor="#E6F7FF"><input type="checkbox" name="wr_2" value="40" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($write[wr_2] == 40) echo "checked";?>> 박스광스 </td>
<td>&nbsp;</td>
<td>40 p/30일</td>
<td><img src="<?=$board_skin_path?>/img/miri.gif" align="absmiddle"></td>
</tr>
...
<tr bgcolor="ffffff">
<td bgcolor="#E6F7FF"><input type="checkbox" name="wr_3" value="30" onClick="this.form.wr_point.value=checkChoice(this);"<? if ($write[wr_3] == 30) echo "checked";?>> 프리미엄 </td>
...
<td><table width="100%" >
<tr>
<td width="20"><input type="checkbox" name="four01" value="20" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($four01 == 20) echo "checked";?>></td>
<td><img src="<?=$board_skin_path?>/img/icon_1.gif" align="absmiddle"></td>
<td width="20"><input type="checkbox" name="four04" value="20" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($four04 == 20) echo "checked";?>></td>
<td><img src="<?=$board_skin_path?>/img/icon_2.gif" align="absmiddle"></td>
<td width="20"><input type="checkbox" name="four05" value="20" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($four05 == 20) echo "checked";?>></td>
...
<tr bgcolor="ffffff">
<td bgcolor="#E6F7FF"><input type="checkbox" name="four02" value="10" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($four02 == 10) echo "checked";?>> 볼드 </td>
...
<tr bgcolor="ffffff">
<td bgcolor="#E6F7FF"><input type="checkbox" name="four03" value="10" onClick="this.form.wr_point.value=checkChoice(this);" <? if ($four03 == 10) echo "checked";?>> 글자색</td>
