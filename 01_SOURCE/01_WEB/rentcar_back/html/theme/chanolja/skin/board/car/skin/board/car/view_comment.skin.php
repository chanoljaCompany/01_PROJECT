...
<tr valign="top"><td align="center" height="30"><?=$c_pagelist?></td></tr>
</table>
...
<tr>
    <td colspan="2" style="padding:5px 0 0 5px;">
        <span style="cursor: pointer;" onclick="textarea_decrease('wr_content', 3);"><img src="<?=$board_skin_path?>/img/co_btn_up.gif"></span>
        <span style="cursor: pointer;" onclick="textarea_original('wr_content', 3);"><img src="<?=$board_skin_path?>/img/co_btn_init.gif"></span>
        <span style="cursor: pointer;" onclick="textarea_increase('wr_content', 3);"><img src="<?=$board_skin_path?>/img/co_btn_down.gif"></span>
        <? if ($is_guest) { ?>
