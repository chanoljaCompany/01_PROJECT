...
<!--배너-->
<div id="sky" style="position:absolute;z-index:100;top:70px;left:50%;margin-left:650px;width:514px; height:353px;border:0px solid gray;">
        ...
        <div class="inner">
            ...
            <div id="tnb">
                <ul>
                    ...
                    <?php }  ?>
					<!--<li class="you"><a href="https://www.youtube.com/@user-qb5rm8jv4o"></a></li>		
                    <li class="insta"><a href="https://www.youtube.com/@user-qb5rm8jv4o"></a></li>-->
                </ul>
            </div>
