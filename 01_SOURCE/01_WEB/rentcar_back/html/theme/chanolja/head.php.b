    ...
    $(function() {
        ...
        setInterval(function() {
            if ($(window).scrollTop() >= 90) {
                ...
                $("#logoA img.logo_pc").attr("src", "<?php echo G5_THEME_IMG_URL ?>/common/logo.png");
            } else {
                $("#hd").removeClass("scrollBg");
                $("#logoA img.logo_pc").attr("src", "<?php echo G5_THEME_IMG_URL ?>/common/logo_white.png");
            }
        }, 300);
    });
</script>
...
<div id="sky" style="position:absolute;z-index:100;top:560px;left:50%;margin-left:500px;width:320px; height:220px;border:0px solid gray;">
<a href="http://songcar.dothome.co.kr/bbs/write.php?bo_table=qa"><img src="<?=G5_THEME_IMG_URL;?>/sidebanner.png"></a>
</div>
<button class="close-button"><img src="<?=G5_THEME_IMG_URL;?>/close.png" width="320px" height="30px"></button>
</div>
<script>
...
<!-- 상단 시작 { -->
<div id="hd">
	<div style="position:absolute;z-index:101;top:30px;left:50%; margin-left:470px; width:250px; height:60px;border:0px solid gray;">
    <a href="https://www.youtube.com/@user-qb5rm8jv4o"><img src="<?php echo G5_THEME_IMG_URL ?>/you.png"></a>
    </div>
