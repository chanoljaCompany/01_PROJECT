...
<div id="sit_ov_wrap" class="box">
    ...
    <div id="sit_pvi">
        ...
        for($i=1; $i<=10; $i++) {
            ...
            if($img) {
                // 썸네일
                $thumb = get_it_thumbnail($it['it_img'.$i], 90, 90);
                $thumbnails[] = $thumb;
                $big_img_count++;
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        <h2>상품간략정보</h2>
        <div class="sit_ov_wr">
             <font size="4px" color="#00547b" > 자동차 기본 정보 </font>
            <strong id="sit_title"><?php echo stripslashes($it['it_name']); ?></strong>
            ...
            <div class="sit_price">
				...
				<font size="4px" color="#00547b" > <strong> 렌트 견적</strong> </font>
                    
                    <span>
                        <!--<?php echo display_price(get_price($it_1)); ?> 
                        <input type="hidden" id="it_price" value="<?php echo get_price($it_1); ?>"> -->
						<br>
					     <?php
						 echo $it['it_1']."</br>\n";
 						 //echo $it['it_2']."</br>\n";
...
<!--<section id="sit_ov2" class="2017_renewal_itemform2"> -->
<section id="sit_ov2" class="">
        <script>
		...
		<div class="buy_wr">
            ...
            <section class="sit_option_wr">
                <font style="font-size: 1.4em; color : #00547b; font-weight: bold;" >필수선택옵션</font>
            ...
            <section class="sit_option_wr">
                ...
                <font style="font-size: 1.4em; color : #00547b; font-weight: bold;" >계약기간 및 선택옵션</font>
            ...
            <div id="sit_ov_btn">
				...
				<center><button type="submit" onclick="document.pressed=this.value;" value="상담하기" id="sit_btn_buy" class="btn_b02">계약상담하기</button></center>
