...
<div id="sod_frm" class="sod_frm_mobile">
    ...
    <section id="sod_frm_orderer" >
        ...
        <div class="odf_list">
            <ul>
                <li>
                    <label for="od_itname">신청차량명<strong class="sound_only"> </strong></label></th>
                    <!--<td><input type="text" name="od_itname" value="<?php echo stripslashes($it_options) ; ?>" id="od_itname" required class="frm_input required" maxlength="20"></td>-->
        ...
        <div class="odf_list">
            <ul>
                ...
                if($is_member) {
                    ...
                    $addr_list .= '<label for="ad_sel_addr_same">계약신청자와 동일</label>'.PHP_EOL;
	...
	<section id="sod_frm_pay">
        ...
        <div class="odf_tbl" style="display:none">
            <table>
            <tbody>
            <?php if($oc_cnt > 0) { ?>
            <tr>
        ...
        if ($default['de_bank_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label for="od_settle_bank" class="lb_icon  bank_icon">개인정보활용동의</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_bank_use']) {
            ...
            //echo $bank_account;
            echo '<br><label for="od_deposit_name">계약신청자명</label> ';
