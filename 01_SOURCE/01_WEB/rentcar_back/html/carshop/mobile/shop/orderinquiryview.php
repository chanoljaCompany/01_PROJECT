...
<div id="sod_fin">
    ...
    <div id="sod_fin_no">상담번호 <strong><?php echo $od_id; ?></strong></div>
    ...
    <section class="sod_fin_list">
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            <li class="sod_li">
                ...
                <div class="li_total" style="display:none">
        ...
        <div id="sod_sts_wrap">
            ...
            <div class="btn_wr" style="display:none" ><button type="button" id="sod_sts_explan_open">상태설명보기</button></div>
        ...
        $tot_price = $od['od_cart_price'] + $od['od_send_cost'] + $od['od_send_cost2']
                        ...
                        - $od['od_cancel_price'];
        ?>
        <div class="sod_ta_wr" style="display:none">
            <dl id="m_sod_bsk_tot">
    ...
    <div id="sod_fin_view">
        ...
        <section id="sod_fin_pay" style="display:none">
            <h3>결제정보</h3>
    ...
    <section id="sod_fin_tot" style="display:none">
        <h2>결제합계</h2>
    ...
    <section id="sod_fin_cancel">
        ...
        <button type="button" onclick="location.href='http://songcar.dothome.co.kr/sub/rentcar.php';">홈으로 돌아가기</button> 
