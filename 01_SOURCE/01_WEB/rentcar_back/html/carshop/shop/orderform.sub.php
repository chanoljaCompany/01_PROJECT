...
<div class="sod_form" style="left-margin : 50px; height : 1410px";>
<div id="sod_frm" class="sod_frm_pc">
    <!-- 주문상품 확인 시작 { -->

 <div class="sod_left" style="background: #eceff4;">
    <div class="tbl_head03 tbl_wrap od_prd_list">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            $image = get_it_image($row['it_id'], 500, 500);
            ...
            $it_car = stripslashes($row['it_name']) ;
        ...
        <tr>
               <center><div class="sod_img"><?php echo $image; ?></div>                </center>
            <td class="td_prd" style="border : 0px;"> 
                <div class="sod_name">
...
<!-- 주문하는 정보 -->
    ...
    <div class="sod_right">
        ...
        <section id="sod_frm_orderer">
            ...
            <h2>중고차렌트 희망 계약자정보</h2>

            <div class="tbl_frm01 tbl_wrap" style="background: #eceff4;">
                <table>
                <tbody>

                 <tr>
                    <th scope="row"><label for="od_itname">신청차량명<strong class="sound_only"> </strong></label></th>
                    <td><input type="text" name="od_itname" value="<?php echo  $it_car ; ?>" id="od_itname" required class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
				...
				<tr>
                    <th scope="row"><label for="od_memo">상담의뢰내용</label></th>
  ...
  <input type="checkbox" name="mycheckbox" id="mycheckbox1" value="0" > 탁송지 정보 입력(선택) <br>
      ...
      <section id="sod_frm_taker">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                if($is_member) {
                    ...
                    $addr_list .= '<label for="ad_sel_addr_same">게약자자 동일</label>'.PHP_EOL;
                    ...
                    $addr_list .= '<label for="ad_sel_addr_same">계약자와 동일</label>'.PHP_EOL;
                }
                ?>
                <tr>
...
<!-- 합계 -->
    ...
    <div class="sod_frm">
        ...
        ?>
-->
        <section id="sod_frm_pay" alt="상담의뢰서제출하기">
            <h2></h2>

            <div class="pay_tbl" style="display:none">
                <table>
                <tbody>
                <?php if($oc_cnt > 0) { ?>
                <tr>
            ...
            <div id="od_tot_price" style="display:none">
                <span>총 주문금액</span>
            ...
            <div id="od_pay_sl">
				...
				if ($default['de_bank_use']) {
                    $multi_settle++;
                    echo '<input type="hidden" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> '.PHP_EOL;
                    //echo '<input type="hidden" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label for="od_settle_bank" class="lb_icon bank_icon">작성완료하기</label>'.PHP_EOL;
                    $checked = '';
                }
				?>
...
<!--
                ...
                if ($default['de_bank_use']) {
                    $multi_settle++;
                    //echo '<input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label>상담의뢰서를 정확히 작성하였습니까?</label>'.PHP_EOL;
                    echo '<input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label for="od_settle_bank" class="lb_icon bank_icon">작성완료하기</label>'.PHP_EOL;
                    $checked = '';
                }
...
-->
                ...
                if ($default['de_bank_use']) {
                    ...
                    echo $bank_account;
					echo '<br><label for="od_deposit_name"></label> ';
					// echo '<input type="text" value='111111 name="od_deposit_name" id="od_deposit_name" size="10" maxlength="20">';
   				    echo '<input type="checkbox" name="od_deposit_name" >';
                    echo '</div>';
                }
...
$(function() {
    ...
    $(document).on("click", ".od_cp_apply", function() {
        ...
        if(!$("#od_coupon_cancel").length)
            $("#od_coupon_btn").after("<button type=\"button\" id=\"od_coupon_cancel\" class=\"cp_cancel\">????????</button>");
    });
