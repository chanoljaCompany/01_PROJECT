...
<section id="anc_sitfrm_skin" style="display:none"> 
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1">이달의특가 </label>
        ...
        <tr>
            <th scope="row"><label for="it_origin">연식</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="it_brand">유종</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="it_model">등급분류</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
		...
		<!-- 추가정보 -->
        <tr>
            <th scope="row"><label for="it_8">배기량</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_8" value="<?php echo get_text($it['it_8']); ?>" id="it_8" class="frm_input" size="40">
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_8" value="1" id="chk_ca_it_8">
                <label for="chk_ca_it_8">분류적용</label>
                <input type="checkbox" name="chk_all_it_8" value="1" id="chk_all_it_8">
                <label for="chk_all_it_8">전체적용</label>
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="it_9">변속기</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_9" value="<?php echo get_text($it['it_9']); ?>" id="it_9" class="frm_input" size="40">
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_9" value="1" id="chk_ca_it_9">
                <label for="chk_ca_it_9">분류적용</label>
                <input type="checkbox" name="chk_all_it_9" value="1" id="chk_all_it_9">
                <label for="chk_all_it_9">전체적용</label>
            </td>
        </tr>
		        <tr>
            <th scope="row"><label for="it_10">주행거리</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_10" value="<?php echo get_text($it['it_10']); ?>" id="it_10" class="frm_input" size="40">
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_10" value="1" id="chk_ca_it_10">
                <label for="chk_ca_it_10">분류적용</label>
                <input type="checkbox" name="chk_all_it_10" value="1" id="chk_all_it_10">
                <label for="chk_all_it_10">전체적용</label>
            </td>
        </tr>
...
<section id="anc_sitfrm_compact" style="display:none">
    <h2 class="h2_frm">상품요약정보1111111</h2>
    <?php echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8"> 원_(월 렌트료 대표 금액입니다) 
            </td>
            <td class="td_grpset">
        ...
        <tr>
		-->
            <th scope="row"><label for="it_stock_qty">재고관리</label></th>
            <td>
...
<!--						<td class="td_grpset">
                <input type="radio" name="chk_ca_it_option3" value="1" id="chk_ca_it_option3">
                <label for="chk_ca_it_option3">3차 분류적용</label><br>
                <input type="radio" name="chk_ca_it_option2" value="1" id="chk_ca_it_option2">
                <label for="chk_ca_it_option2">2차 분류적용 (3차 포함)</label><br>
                <input type="radio" name="chk_ca_it_option1" value="1" id="chk_ca_it_option1">
                <label for="chk_ca_it_option1">기본 분류적용 (2,3차 포함)</label>
            </td> -->
                    </tr>
                    </tbody>
                    </table>
...
<section id="anc_sitfrm_sendcost" style="display:none">
...
<section id="anc_sitfrm_relation" class="srel" style="display:none">
...
<section id="anc_sitfrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<?php
        $f_subjs = array('blank','가격플랜1', '가격플랜2', '가격플랜3', '가격플랜4', '기타1', '기타2', '기타3');
        for ($i=1; $i<=7; $i++) { ?>
        <tr>
            <!--<th scope="row"><label for="mb_<?php echo $f_subjs[$i]?>"></label></th>-->
			<th scope="row"><label for="mb_<?php echo $i ?>"> <?php echo $f_subjs[$i]?></label></th>
			<!--<th scope="row"><label for="mb_<?php echo $i ?>">여분 필드 <?php echo $i ?></label></th>-->
            <td class="td_extra">
                <label for="it_<?php echo $i ?>_subj"><!--여분 필드<?php echo $i ?>--> 제목</label>
				                <input type="text" name="it_<?php echo $i ?>_subj" id="it_<?php echo $i ?>_subj" value="<?php echo get_text($it['it_'.$i.'_subj']) ?>" class="frm_input">
                <label for="it_<?php echo $i ?>"><!--여분필드 <?php echo $i ?>--> 내역</label>
