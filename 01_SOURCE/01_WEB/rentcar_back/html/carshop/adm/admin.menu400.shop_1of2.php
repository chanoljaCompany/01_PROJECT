...
$menu['menu400'] = array(
    array('400000', '중고차렌트카관리', G5_ADMIN_URL . '/shop_admin/', 'shop_config'),
    array('400010', '문의현황', G5_ADMIN_URL . '/shop_admin/', 'shop_index'),
    //array('400100', '쇼핑몰설정', G5_ADMIN_URL . '/shop_admin/configform.php', 'scf_config'),
    array('400400', '문의내역', G5_ADMIN_URL . '/shop_admin/orderlist.php', 'scf_order', 1),
