...
define('G5_MYSQL_USER', 'cambranch');
define('G5_MYSQL_PASSWORD', 'aqws1793!');
define('G5_MYSQL_DB', 'cambranch');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'topsmobil_');

define('G5_TOKEN_ENCRYPTION_KEY', '2ae85b0defd46e6ad4f4efd4428fad4a'); // 토큰 암호화에 사용할 키
