...
<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1712131385523" class="root_daum_roughmap root_daum_roughmap_landing"></div>
    ...
    new daum.roughmap.Lander({
        ...
        "mapHeight" : "360"
            ...
            <div class="map_info elm">
                ...
                <div class="rt_box">
                    <strong>차놀자캠핑 부산대저지점</strong>
                    <p>
                        <span>ADDRESS</span>
                        <span>부산광역시 강서구 대저로155번길 15, 1층 B동(대저1동)</span>
                    </p>
                    <p>
                        <span>Tel</span>
                        <span>010-4655-6845</span>
                    </p>
                </div>
            </div>
