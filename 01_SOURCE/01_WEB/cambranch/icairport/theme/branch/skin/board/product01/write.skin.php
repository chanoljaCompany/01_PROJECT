            ...
            <article class="inner">
                <section id="bo_w">
                    ...
                    <div class="infoBox">
                        <ul>
                            <li>
                                <label for="wr_1" class="sound_only">운전면허</label>
                                <input type="text" name="wr_1" value="" id="wr_1" class="frm_input" placeholder="운전가능한 면허종류를 입력하세요">
                            </li>
                            <li>
                                <label for="wr_2" class="sound_only">취침인원</label>
                                <input type="text" name="wr_2" value="" id="wr_2" class="frm_input" placeholder="취침가능인원을 입력하세요">
                            </li>
                            <li>
                                <label for="wr_3" class="sound_only">반려동물가능여부</label>
                                <input type="text" name="wr_3" value="" id="wr_3" class="frm_input" placeholder="반려동물가능여부를 입력하세요">
                            </li>
                            <li>
                                <label for="wr_4" class="sound_only">주요기능</label>
                                <input type="text" name="wr_4" value="" id="wr_4" class="frm_input" placeholder="캠핑카 주요기능을 입력하세요">
                            </li>
                        </ul>                        
                    </div>
