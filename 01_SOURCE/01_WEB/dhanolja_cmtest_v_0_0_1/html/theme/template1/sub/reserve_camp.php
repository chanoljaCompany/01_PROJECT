...
$act_target = trim(isset($_REQUEST['act_target'])) ? $_REQUEST['act_target'] : '';//액트타겟
$car_code = trim(isset($_REQUEST['car_code'])) ? $_REQUEST['car_code'] : '';//상품타입
$guestroom_name = trim(isset($_REQUEST['guestroom_name'])) ? $_REQUEST['guestroom_name'] : ''; //상품명검색
...
<form name="reserveForm" id="reserveForm">
                         ...
                         <input type="hidden" name="com_name" id="com_name"  value="">                         
...
<br>		 	 
    ...
    <!-- <div class="creating_box" style="display: flex;
    align-items: center;
    ...
    flex-direction: column;">
        ...
        <img src="http://www.chanolja.co.kr/theme/template1/img/top_문의.jpeg" style=" width: 100%;  max-width: 600px;" usemap="#image-map" href="tel:1811-6526" onclick="document.location.href='tel:1811-6526'">
        <img src="http://www.chanolja.co.kr/theme/template1/img/bottom_문의.jpeg" style=" width: 100%;  max-width: 600px;" usemap="#image-map" href="http://chatour.dothome.co.kr/bbs/board.php?bo_table=52"
        onclick="document.location.href='http://chatour.dothome.co.kr/bbs/board.php?bo_table=52'">
...
<div class="subpage">
    ...
    <!-- 실제경로 \client\act\get_guestroom_detail.php-->
    </div>
    <!-- 상세페이지 끝 -->
</div>
</div>
