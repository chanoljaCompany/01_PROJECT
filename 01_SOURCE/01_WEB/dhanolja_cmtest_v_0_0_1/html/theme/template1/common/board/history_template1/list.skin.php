...
<div class="row">
	...
	<div class="col-md-9  col-sm-6 col-xs-12">
        ...
        <table class="ui table unstackable celled definition large">
            <tbody>
                <tr>
                    <td class="four wide">회사명</td>
                    <td><?=$config[cf_1]?></td>
                </tr>
                <tr>
                    <td>대표이사</td>
                ...
                <tr>
                    <td>대표번호</td>
                    <td>TEL.  <?=$config[cf_4]?> / FAX.  <?=$config[cf_5]?></td>
                </tr>
                <tr>
                    <td>대표이메일</td>
                    <td><?=$config[cf_7]?></td>
        ...
        <div style="margin:15px 0;text-align:center">
            <?php if($is_admin == 'super') { ?>
                <a href="../adm/board_form.php?w=u&bo_table=<?php echo $bo_table; ?>&sst=&sod=&sfl=&stx=&page=" class="btn_b02">기타실적수정</a>
            <?php } ?>
        </div>
    </div>
</div>
