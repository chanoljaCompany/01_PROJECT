...
if($division == "inquire"){ //문의일때...
  $searchVal_str = "AND (board_type = 'A' OR board_type = 'B')"; //취소신청.취소완료
  }else{ //예약리스트
  $searchVal_str = "";
}
...
$html ="";
        ...
        if($rows['board_type'] == 'B'){
          $reply_str = "[답변완료]";
          $nbaord_form = "nboard_view_form";
          $reply_meun_name = "답변수정";
        }
//         echo "
// reply_str >>> $reply_str <br>
//         ";
				$html .= "<tr>
									<td>".$num_a."</td>
                  <td>".$rows['wr_datetime']."</td>
									<td><a href='".$nbaord_form.".php?top_menu_id=".$top_menu_id."&left_menu_id=".$left_menu_id."&wr_id=".$rows['wr_id']."&curpage=".$page."'>".$rows['wr_subject'].$reply_str."</td>
									<td>".$rows['wr_name']."</td>
                  ...
                  <td><span class='box_btn_s blue'><a class='btn btn-success btn-sm'  href='nboard_reply_form.php?top_menu_id=".$top_menu_id."&left_menu_id=".$left_menu_id."&wr_id=".$rows['wr_id']."&curpage=".$page."'>".$reply_meun_name."</a></span></td>
