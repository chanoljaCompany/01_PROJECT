...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div style='text-align:left; padding:10px'>
			여행국가: <?php echo $view['wr_subject'] ?>
		</div>
        <div style='text-align:left; padding:10px'>
			체류지역: <?php echo $view['wr_1'] ?>
		</div>
        <div style='text-align:left; padding:10px'>
			여행기간: <?php echo $view['wr_2'] ?> ~ <?php echo $view['wr_3'] ?>
		</div>
		<?php if($view['wr_4'] != '') { ?>
        <div style='text-align:left; padding:10px'>
			여행목적: <?php echo $view['wr_4'] ?>
		</div>
		<?php } ?>
		<?php if($view['wr_5'] != '') { ?>
        <div style='text-align:left; padding:10px'>
			여행비용: <?php echo $view['wr_5'] ?>
		</div>
		<?php } ?>
        <div style='text-align:left; padding:10px'>
			평가 
			<span class="score">
		        ...
		        <span class="stars-active" style="width:<?php $t = $view['wr_6']*20; echo $t;?>%">
  ...
  <div class="fotorama"
     data-nav="thumbs" data-thumbwidth='128' data-thumbheight='128' data-width="800"
    >
        <?php
        // 파일 출력
        ...
        if($v_img_count) {
            ...
            for ($i=0; $i<=count($view['file']); $i++) {
             echo '<img src="'.'../data/file/'.$bo_table.'/'.$view['file'][$i]['file'].'" >';
            }
