         ...
         ?>
            ...
            <div class="bo_fx">
                <div class="clearfix">
                    ...
                    <ul class="btn_bo_user">
                        <?php if ($is_checkbox) { ?>
                        <li><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_admin btn_change2 gray_btn" style="
                            background: #e5ecef;
                            color: black;
                            border : none;"><i class="fa fa-trash-o" aria-hidden="true"></i> 선택삭제</button></li>
                        <li><button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn btn_admin btn_change2 gray_btn" style="
                            background: #e5ecef;
                            color: black;
                            border : none;"><i class="fa fa-files-o" aria-hidden="true"></i> 선택복사</button></li>
                        <li><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value" class="btn btn_admin btn_change2 gray_btn" style="
                            background: #e5ecef;
                            color: black;
                            border : none;"><i class="fa fa-arrows" aria-hidden="true"></i> 선택이동</button></li>
                        <?php } ?>
