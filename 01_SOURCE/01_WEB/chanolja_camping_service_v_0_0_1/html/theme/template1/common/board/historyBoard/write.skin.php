	...
	<div class="form-row">
		<div class="form-group col-lg-2">
			<div class="input-group mb-3">
				<select name=wr_3 required itemname="년도" class="form-control">
        			<? for($years=$board["bo_1"];$years<=$board["bo_2"];$years++) { ?>
        			<option value="<?= $years ?>" <?= $write["wr_3"] == $years ? "SELECTED" : "" ?> ><?= $years ?></option>
        			<? } ?>
        		</select>
		...
		<div class="form-group col-lg-2">
			<div class="input-group mb-3">
            	<select name=wr_1 required itemname="월" class="form-control">
		...
		<div class="form-group col-lg-2">
			<div class="input-group mb-3">
            	<select name=wr_2 required itemname="일" class="form-control">
        			<? for($dt=1;$dt<=31;$dt++) {
        				$dt=sprintf("%02d",$dt);
        			?>
