			...
			<div class="col-md-3 col-sm-6 col-xs-12 sidebar-right content-widget pdsl">
				...
				<!--<div class="blog-left-side widget">
					<div class="widget widget_categories">
						...
						<ul>
							<?php while($sideMenu = sql_fetch_array($sideMenus)) : ?>
							<li class="cat-item cat-item-8" style="<?= $bo_table == $sideMenu["bo_table"] ? "color:#005bac" : ""?>">
								<a href="/bbs/board.php?bo_table=<?= $sideMenu["bo_table"] ?>" style="<?= $bo_table == $sideMenu["bo_table"] ? "color:#005bac" : ""?>"><?= $sideMenu["bo_subject"] ?></a>
							</li>
							<?php endwhile; ?>
						</ul>
					</div>
