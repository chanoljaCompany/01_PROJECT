...
<div class="row">
    ...
    <div class="col-md-9  col-sm-6 col-xs-12">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_num" style="width:60px"><?php if ($list[$i]['comment_cnt']) { ?><div style="padding:0;width:60px;height:20px;background:#9e0039;color:#fff;font-weight:bold;">답변완료</div><?php }elseif($list[$i]['wr_1']){ ?><div style="padding:4px 0 0 0;width:60px;height:20px;background:#2460bb;color:#fff;font-weight:bold;">확인중</div><?php }else{ ?><div style="padding:4px 0 0 0;width:60px;height:20px;background:#878ED3;color:#fff;font-weight:bold;">상담신청</div><?php } ?></td>
