...
$n_thumb_width = 160; //썸네일 가로 크기
$n_thumb_height = 40; //썸네일 세로 크기
?>

<script type="text/javascript">
var sliderwidth="100%"  //스크롤 가로 사이즈
var sliderheight="<?=$n_thumb_height + 10;?>px"  //스크롤 세로 사이즈
var slidespeed="1"  
...
function left(){
    ...
    document.write('<tr><td align=left valign=middle width=35><img style="border:0;" src='+leftarrowimage+' onMouseover="left(); copyspeed=2" onMouseout="copyspeed=1" style="cursor:hand"></td>')
...
document.write('<td width="35" align=right valign=middle><img style="border:0" src='+rightarrowimage+' onMouseover="right();copyspeed=2" onMouseout="copyspeed=1" style="cursor:hand"></td></tr></table>')
