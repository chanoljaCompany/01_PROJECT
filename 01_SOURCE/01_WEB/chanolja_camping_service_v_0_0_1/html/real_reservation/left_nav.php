  ...
  <ul id="manageSideMenu">
    ...
    <ul id="pgcode1000" class="sideSmall" >
      <li <?=$left_menu_020_sel?>>
         <a href="/real_reservation/car_control/car_control.php?top_menu_id=4001&left_menu_id=020" class="small" >차량정보관제</a>
      </li>
    </ul>
    </li>
    <li class="title over">
    <a class="mid" data="1000" href="http://chatour.dothome.co.kr"><span class="icon" style="background:url('<?=$file_url?>/img/go_back.png') no-repeat center; background-size:16px 16px;"></span>메인페이지이동</a>
    </li>
