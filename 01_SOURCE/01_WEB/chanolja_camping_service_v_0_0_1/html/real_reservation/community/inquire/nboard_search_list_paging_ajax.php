...
// echo "
// $searchVal_1 > $searchVal_1 <br>
// $searchVal_2 > $searchVal_2 <br>
// $searchVal_3 > $searchVal_3 <br>
// $searchVal_4 > $searchVal_4 <br>
// $searchVal_5 > $searchVal_5 <br>
// $searchVal_6 > $searchVal_6 <br>
// range_start >> $range_start <br>
// range_end >> $range_end <br>
// ";

if($division == "inquire"){ //취소관리일때...
...
// $searchVal_2 = trim($_REQUEST["searchVal_2"]); //기간
// $searchVal_3 = trim($_REQUEST["searchVal_3"]); //예약자 정보
// $searchVal_4 = trim($_REQUEST["searchVal_4"]); //결제수단
// $searchVal_5 = trim($_REQUEST["searchVal_5"]); //결제여부
// $searchVal_6 = trim($_REQUEST["searchVal_6"]); //예약상태

$searchVal_4 = implode( ',', $searchVal_4 );
...
if ($total_page > 0 && $page > 1) {
    $go_page = $page - 1;
    $html .= "<a href='#' onclick=\"showTable('" . $division . "','" . $searchKey_1 . "','" . $searchVal_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "','" . $searchKey_3 . "','" . $searchVal_3 . "','" . $searchVal_4 . "','" . $searchVal_5 . "','" . $searchVal_6 . "', '" . $go_page . "', '" . $top_menu_id . "', '" . $left_menu_id . "')\">Previous</a>";
}
...
for ($page_link = $first + 1; $page_link <= $last; $page_link++) {
    if ($page_link == $page) {
        ...
        $html .= "<a href='#' onclick=\"showTable('" . $division . "','" . $searchKey_1 . "','" . $searchVal_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "','" . $searchKey_3 . "','" . $searchVal_3 . "','" . $searchVal_4 . "','" . $searchVal_5 . "','" . $searchVal_6 . "', '" . $page_link . "', '" . $top_menu_id . "', '" . $left_menu_id . "')\">" . $page_link . "</a>";
    }
}

if ($total_page > $page) {
    $go_page = $page + 1;
    $html .= "<a href='#' onclick=\"showTable('" . $division . "','" . $searchKey_1 . "','" . $searchVal_1 . "','" . $searchKey_2 . "','" . $searchVal_2 . "','" . $searchKey_3 . "','" . $searchVal_3 . "','" . $searchVal_4 . "','" . $searchVal_5 . "','" . $searchVal_6 . "', '" . $go_page . "', '" . $top_menu_id . "', '" . $left_menu_id . "')\">Next</a>";
}
