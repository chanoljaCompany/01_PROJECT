...
include_once(G5_PENSION_PATH.'/clent/settle_kcp.inc.php');
...
{
    $g_conf_key_dir   = G5_PENSION_PATH.'/kcp/bin/pub.key';
    $g_conf_log_dir   = G5_PENSION_PATH.'/kcp/log';
}
...
include_once(G5_PENSION_PATH.'/kcp/pp_cli_hub_lib.php');
