...
<body>
    <!-- <h1>실시간예약</h1> -->
    <div class="main_wrap"   id="loadingArea">
                       ...
                       <h3 class="hide">tab header</h3>
                        <div class="tab_header_wrapper">
                            <ul class="travel_scroll_tab_headers">
                                <!-- <li <? if($divisionType == '1'){?> class="selected" <?}?>><a href="/bbs/board.php?bo_table=82&divisionType=1">숙박상품</a></li>
                                <li <? if($divisionType == '2'){?> class="selected" <?}?>><a href="/bbs/board.php?bo_table=82&divisionType=2">당일상품</a></li>
                                <li <? if($divisionType == '3'){?> class="selected" <?}?>><a href="/bbs/board.php?bo_table=82&divisionType=3">셀프바베큐존</a></li> -->
                                <li id= "rconfirm_1" <? if($divisionType == '1'){?> class="selected" <?}?>><a href="javascript:void(0);" onclick="getData(1)">숙박상품</a></li>
                                <li id= "rconfirm_2" <? if($divisionType == '1'){?> class="selected" <?}?>><a href="javascript:void(0);" onclick="getData(2)">당일상품</a></li>
                                <li id= "rconfirm_3" <? if($divisionType == '1'){?> class="selected" <?}?>><a href="javascript:void(0);" onclick="getData(3)">셀프바베큐존</a></li>
                                <li id= "rconfirm_4" <? if($divisionType == '4'){?> class="selected" <?}?>><a href="javascript:void(0);" onclick="reserveConfim(4)">예약확인</a></li>
                            </ul>
                        </div>
                    </section>
                            ...
                            <section id="sec1">
                               <h4 class="hide">section 1</h4>
                                <div class="input_box">
                                    ...
                                    <span><a href='javascript:void(0);' onclick="findSearchData();" class="btn_lookup">객실조회</a></span>
                                </div>
