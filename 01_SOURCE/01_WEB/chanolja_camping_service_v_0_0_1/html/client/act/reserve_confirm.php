...
$rresult = sql_query($rsql);
  ...
  if($conType == '1'){ //모바일
   ...
   $html .= "<div class='table_wrap_mo'>
            ...
            $html .= "</td>
                      ...
                      <tr>
                          <th colspan='3'><a href='javascript:void(0)' onclick=\"reserve_confirm_detail('".$reserveData['guestroom_reserve_code']."','".$ii."')\">상세보기</a></th>
                      </tr>
                  </tbody>
              </table>
          </div>";
          $html .= "<div class='reserve_confirm_detail_data' id='reserve_confirm_detail_data_".$ii."'></div>";
          $ii++;
    }
  }
  else{//PC
  ...
  $html .= "<div class='table_wrap_pc'>
                ...
                <table class='table_inquiry_1'>
                    ...
                    <tbody>
                        <tr>
                            <td><a href='javascript:void(0)' onclick=\"reserve_confirm_detail('".$reserveData['guestroom_reserve_code']."','".$ii."')\">".$reserveData['guestroom_name']."</td>";
                            if($reserveData['guestroom_type'] == '1'){
                  ...
                  $html .= "<td>".number_format($reserveData['guestroom_fee'])."원</td>
                            ...
                            <td><a href='javascript:void(0)' onclick=\"reserve_confirm_detail('".$reserveData['guestroom_reserve_code']."','".$ii."')\">상세보기</td>
                        </tr>
                        <tr>
                        <td colspan='7'>
                        선택옵션 : <br>";
